# Vendored from https://github.com/NixOS/nixpkgs/, file
# nixos/modules/tasks/filesystems.nix, revision 5de0b32be6e85d
#
# Licensed under the MIT license, see
# https://github.com/NixOS/nixpkgs/blob/c021df579277/COPYING
