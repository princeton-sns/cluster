# Patched version, vendored from
# https://github.com/NixOS/nixpkgs/blob/ef176dcf7e76c3/nixos/modules/services/matrix/synapse.nix
# (Licensed under the MIT license:
# https://github.com/NixOS/nixpkgs/blob/ef176dcf7e76c3639571d7c6051246c8fbadf12a/COPYING)
#
# This patch adds the `overrideLocalPostgresCheck` option.
